...
public class ParameterizedJunit4Demo {
    ...
    public static Collection<Integer[]> getTestParameters() {
       return Arrays.asList(new Integer[][] {
          ...
          {0, -10,10},  //expected, valueOne, valueTwo
          {-20, -10,-10},  //expected, valueOne, valueTwo
          {20000, 10000,10000},  //expected, valueOne, valueTwo
       });
    }

    public ParameterizedJunit4Demo(double expected, 
